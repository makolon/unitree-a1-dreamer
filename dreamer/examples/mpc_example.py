...
import sys
sys.path.append('..')
from envs import env_builder as env_builder
...
def _run_example(max_time=_MAX_TIME_SECONDS):
  ...
  env = env_builder.build_regular_env( motor_control_mode = robot_config.MotorControlMode.HYBRID, enable_rendering=True)
  env.reset()
